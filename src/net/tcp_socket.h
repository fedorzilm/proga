...
// MAX_MESSAGE_PAYLOAD_SIZE теперь ожидается из common_defs.h
// УДАЛЕНО: constexpr uint32_t MAX_MESSAGE_PAYLOAD_SIZE = 1024 * 1024 * 10; // 10 MB
...
public:
    ...
    bool listenSocket(int backlog = SOMAXCONN); // SOMAXCONN теперь должен быть известен
