// fedorzilm/proga/proga-master/unit_tests/test_logger.cpp
...
// (Оставляем как есть, но будем использовать осторожнее для init сообщений)
...
// Helper для поиска строки, содержащей все части (более гибкий)
