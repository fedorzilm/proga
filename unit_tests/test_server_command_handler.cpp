...
TEST_F(ServerCommandHandlerTest, HandleCalculateCharges_Success_Integration) {
    ...
    std::string expected_status_msg = "Расчет успешно выполнен для 1 записей.";  
...
TEST_F(ServerCommandHandlerTest, HandleSave_Success_Integration) {
    ...
    std::string expected_status_msg = "Данные успешно сохранены в файл '" + filename_to_save + "'. Сохранено 2 записей."; 
