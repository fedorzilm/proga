...
TEST_F(ServerCommandHandlerTest, HandleCalculateCharges_Success_Integration) {
    ...
    std::string expected_status_msg = "Расчет успешно выполнен для 1 запис(ей|и|ь).";
...
TEST_F(ServerCommandHandlerTest, HandleLoad_Success_Integration) {
    ...
    std::string expected_status_msg = "Данные успешно загружены из файла '" + filename_to_load + "'. Загружено 2 запис(ей|и|ь).";
...
TEST_F(ServerCommandHandlerTest, HandleSave_Success_Integration) {
    ...
    std::string expected_status_msg = "Данные успешно сохранены в файл '" + filename_to_save + "'. Сохранено 2 запис(ей|и|ь).";
